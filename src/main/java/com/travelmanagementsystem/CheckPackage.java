...
public class CheckPackage extends JFrame  {
    ...
    private Timer timer;
    private static final String FONT_NAME = "Motserrat";
    private static final String FOOD="CODZIENNIE PYSZNE EGZOTYCZNE ŚNIADANIA";
    private static final String RESERVE="REZERWUJ TERAZ";
    private static final String ANIMACJE="CODZIENNE ANIMACJE DLA DZIECI";
    ...
    CheckPackage(){
        ...
        String[] package2={"SREBRNA OFERTA", " 10 DNI NA MADERZE", "MIEJSCE W 1 KLASIE","WYCIECZKI MIEJSKIE Z PRZEWODNIKIEM 3 RAZY",FOOD,"(oraz jeszcze pyszniejsze obiado-kolacje..)","W CENIE 3 DNIOWY WYJAZD NA GÓRE TUTURURTU","ALKOHOLE/PRZEKĄSKI UNLIMITED DO GODZINY 22",ANIMACJE,RESERVE,OFFERT,NOW,"2400 ZŁ/OS","09:00:00","ikony/package2.jpg"};
        String[] package3={"BRĄZOWA OFERTA"," 7 DNI NA GRAN CANARII", "MIEJSCE W KLASIE EKONOMICZNEJ","WYCIECZKA MIEJSKA Z PRZEWODNIKIEM", FOOD,"OBIAD/KOLACJA WE WŁASNYM ZAKRESIE","W CENIE SPA I MASAŻE","ALKOHOLE/PRZEKĄSKI DO ZAKUPIENIA W BARZE",ANIMACJE,RESERVE,OFFERT,NOW,"2000 ZŁ/OS","09:00:00","ikony/package3.jpg" };
