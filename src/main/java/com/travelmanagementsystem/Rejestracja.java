...
/**
 * Klasa Rejestracja - służy do obsługi zarejestrowania użytkownika i zapisaniu jego danych w bazie.
 */
public class Rejestracja extends JFrame implements ActionListener {
    ...
    /**
     * Konstruktor klasy Rejestracja
     * Inicjalizujemy w nim parametry okna, pola tekstowa, oraz przyciski
     */
    Rejestracja() {
        ...
        create.addActionListener(new ActionListener() {
            /**
             * Nadpisujemy metode actionPerformed i dodajemy funkcjonalność stricte do przycisku, aby warunkowo można
             * było wykonywać różne działanie, względem spełnionego warunku,
             * oraz aby nie ingerować z funkcja actionPerformed znajdujaca sie nizej
    ...
    /**
     * Ta metoda actionPerformed po nacisnieciu przez uzytkownika przycisku create, jeśli wszystkie dane są prawidłowe i wypełnione,
     * zapisuje jego dane do Bazy
     *
     * @param e the event to be processed
     */
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == create) {
            ...
            try (Connect connect = new Connect();
                ...
                if (rowsAffected > 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "Błąd podczas tworzenia konta.");
                }
